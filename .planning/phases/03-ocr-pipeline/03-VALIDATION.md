...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 03-01-01 | 01 | 1 | DATA-04 | unit | `npx vitest run src/main/ocr/ScreenCapturer.test.ts` | No W0 | pending |
| 03-01-02 | 01 | 1 | DATA-04 | unit | `npx vitest run src/main/ocr/RegionCropper.test.ts` | No W0 | pending |
| 03-02-01 | 02 | 1 | DATA-05 | unit | `npx vitest run src/main/ocr/ShopOCR.test.ts` | No W0 | pending |
| 03-02-02 | 02 | 1 | DATA-05 | unit | `npx vitest run src/main/ocr/ChampionMatcher.test.ts` | No W0 | pending |
| 03-03-01 | 03 | 3 | DATA-04 | unit | `npx vitest run src/main/ocr/BoardOCR.test.ts` | No W0 | pending |
| 03-04-01 | 04 | 4 | OVER-03 | unit | `npx vitest run src/main/ocr/ShopVisibilityDetector.test.ts` | No W0 | pending |
| 03-04-02 | 04 | 4 | OVER-03 | unit | `npx vitest run src/main/overlay/BoardStatePoller.test.ts` | Yes (extend) | pending |
...
| Small item icons overlaid on champion corners | DATA-04 | Visual rendering in overlay | Launch TFT, verify item icons appear at champion icon corners (not count badge) |
